...
import devoloperimage from '../assets/devoloper3.jpg'
import { Helmet } from 'react-helmet-async';
import { AuthContext } from './AuthContext';
const Profile = () => {
	const {user} =useContext(AuthContext)
    return (
       <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-black text-white mx-auto my-10">
        <Helmet>
            <title>profile || page</title>
        </Helmet>
	<img src={devoloperimage} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
	<div className="space-y-4 text-center divide-y divide-gray-300">
		<div className="my-2 space-y-1">
			...
			<p className="px-5 text-xs sm:text-base mb-3 dark:text-gray-600">Web developer</p>
		</div>
