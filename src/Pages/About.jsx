    ...
    return (
        ...
        <title>About || page</title>
            ...
            <div className='text-center space-y-6'>
                ...
                <p className='max-w-sm md:max-w-6/12 mx-auto'>Welcome to our App Explorer! We aim to bring you the most innovative, useful, and trending applications in one place. Whether you're looking for productivity tools, entertainment, or utilities – we’ve got something for everyone.</p>
            </div>
           <div className='grid grid-cols-1 mb-3 gap-5 sm:grid-cols-2 md:grid-cols-3 mt-10'>
